...
save_dir      = r"F:\\Tutorials\\"        # Saving Files Main Directory
finished_list = r"logs.txt"               # File that will log all downloaded course directories so the .zip archives can be moved later
course_list   = r"F:\\download_list.txt"  # All courses that we want to be downloaded. Courses list
zip_download  = r"F:\\Download\\"         # Directory that will be used to download zip archives, they will be moved to their folders at the end
